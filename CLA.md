...
> accepted under the terms in the current `CONTRIBUTING.md`.

Thank you for contributing to NeuronEdge Enclave. Before we can accept your
contribution, we need you to agree to this Contributor License Agreement
("CLA"). It protects the project, its users, and you — and it keeps the
project's licensing future flexible.

## Why a CLA (and not just a DCO)

A Developer Certificate of Origin (DCO) certifies that *you wrote* the code
you're submitting. It does **not** grant the project a broad license to your
contribution. Without a CLA, every contribution is owned by its author under
...
way.** This CLA does not change that. It only preserves the *option* to
relicense if the project's circumstances ever require it.

## How to sign

- **Individual contributors:** open a pull request and add your details to
...
_The full legal text is in [`.cla/individual-cla.txt`](.cla/individual-cla.txt)._
_Summary (non-binding):_
...
3. **Relicensing.** You agree that Infrastacks may distribute your
   ...
   License 2.0 with respect to use, modification, and distribution of the code.
   This preserves the project's ability to adapt its licensing without
   re-contacting contributors.
4. **You retain ownership.** This is a license, not an assignment. You keep
   your copyrights; you may use your own contributions for any purpose.
5. **Origin and rights.** You represent that each contribution is your
   original work, that you have the legal right to grant the above licenses,
   and that you are not submitting code governed by a license incompatible
   with Apache-2.0 (in particular, no AGPL, SSPL, or other strong-copyleft
   code).
6. **No support obligation.** You are not obligated to provide support for
   your contributions, except to the extent you choose to.

## Corporate Contributor License Agreement

If you are contributing on behalf of a company, the company must sign the
Corporate CLA at [`.cla/corporate-cla.txt`](.cla/corporate-cla.txt), which
mirrors the Individual CLA and additionally confirms the company holds the
rights to its employees' contributions and authorizes them to contribute.
