...
var RuntimeClient = grpcJs.makeGenericClientConstructor(RuntimeService, "ne.runtime.v1.Runtime");
...
var Client2 = class {
  ...
  constructor(options) {
    ...
    const creds = options.credentials ?? grpcJs.credentials.createInsecure();
      ...
      invoke(callOptions, (err, value) => {
        ...
        if (value === void 0) {
          const synthetic = Object.assign(
            ...
            { code: grpcJs.status.INTERNAL, details: "empty response", metadata: new grpcJs.Metadata() }
          );
          reject(synthetic);
          return;
        }
