...
Import the guest images with `nee image import`, then configure `EnclaveWorkspace` with the same lowercase SHA-256 values. Any environment value can be overridden by a matching kwarg.
